...
def run(args: argparse.Namespace) -> tuple[dict[str, Any], bool]:
    ...
    source_end = (args.source_page_start + args.num_pages) * args.page_size
    ...
    source_indices = expand_pages(
        args.source_page_start,
        args.num_pages,
        args.page_size,
        device=device,
    )
    ...
    for layer_id in range(args.layers):
        device_pool.k_buffer[layer_id][source_indices] = layer_id + 1
        device_pool.v_buffer[layer_id][source_indices] = layer_id + 101
    ...
    payload = {
        ...
        "derived": {
            ...
            "transfer_tokens": source_indices.numel(),
        },
        "result": {},
    }
    ...
    try:
        ...
        for layer_id in (0, args.layers - 1):
            ...
            expected_v = torch.full_like(expected_k, layer_id + 101)
